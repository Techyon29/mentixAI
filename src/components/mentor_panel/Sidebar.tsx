  ...
  return (
    <>
      ...
      <aside className={`
        ...
        bg-gradient-to-b from-[#2A75FF] to-[#0D3694] 
        shadow-[4px_0_24px_rgba(20,80,200,0.15)] 
      ...
      <div className="relative mt-auto p-2 md:p-3 rounded-xl bg-white/10 backdrop-blur-lg border border-white/20 flex flex-col gap-1.5 md:gap-2 shadow-sm shrink-0">
        ...
        <p className="text-white/70 text-[9px] md:text-[10px] font-medium leading-tight">
          Your AI co-pilot for creating better assessments.
        </p>
        <Link 
          href="/ai-assistant"
          className="mt-1 w-full py-1.5 rounded-lg bg-white/10 hover:bg-white/20 border border-white/30 text-white font-semibold text-[10px] md:text-[11px] flex items-center justify-center gap-1.5 transition-all active:scale-95"
        >
